...
class VirtualKeyboard:
    ...
    def __init__(self, master=Tk()):
        ...
        self.master.title("teclado qwerty")
        ...
        # keys in every row
        self.row1keys = ["spacebar", "e", "o", "i", "t", "q", "z", ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ']

        self.row2keys = ["a", "s", "u", "d", "v", "j", '.', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ']

        self.row3keys = ["r", "m", "c", "h", "x", '.', '.', ' .', ' ', ' ', ' ', ' ', ' ', ' ', ' ']

        self.row4keys = ["n", 'l', 'g', 'y', ' .', ' .', '. ', ' .', '.', ' ', ' ', ' ', ' ', ' ', ' ']
        ...
        self.row2buttons[0].config(text="a`")
        self.row2buttons[1].config(text="s")
        self.row2buttons[2].config(text="u")
        self.row2buttons[3].config(text="d")
        self.row2buttons[4].config(text="v")
        self.row2buttons[5].config(text="j")
        ...
        for key in self.row5keys:
            ...
            if key == ",":
                ...
                self.row5buttons[ind].config(text="Shift", width=1)
        ...
        Label(infoframe7, text="youtube", bg=self.gray, fg="white", font=self.neetfont).grid(row=0, column=10, sticky="NSEW")
    ...
    def engine(self):
        ...
        self.tips_space.config(text="", height=2)
